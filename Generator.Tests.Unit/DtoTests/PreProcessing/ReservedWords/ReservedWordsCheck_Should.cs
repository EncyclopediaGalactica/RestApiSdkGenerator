namespace EncyclopediaGalactica.RestApiSdkGenerator.Generator.Tests.Unit.DtoTests.PreProcessing.ReservedWords;
...
public class ReservedWordsCheck_Should : TestBase
{
    ...
    {
        // Arrange && Act
        string currentPath = $"{_basePath}/DtoTests/PreProcessing/ReservedWords";
